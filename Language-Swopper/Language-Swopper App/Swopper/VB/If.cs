...
namespace LswVB
{
    ...
    {
        public static string Write(object One, ref LswVB.CSharpPositions CSharpPosition)
        {
            string Return = "if ";
            LsIf Two = (LsIf)One;
        ...
        public static LsIf Read(string One, ref LswVB.CSharpPositions CSharpPosition)
        {
            LsIf Two = new LsIf();
